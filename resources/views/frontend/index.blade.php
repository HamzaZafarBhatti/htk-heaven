        ...
        <div class="swiper-container thm-swiper__slider"
            ...
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                    ...
                    <div class="main-slider-seven__img">
                        <img src="{{ asset('assets/images/update-17-06-2023/resources/main-slider-seven-img-2.jpg') }}"
                            alt="">
                        <div class="main-slider-seven__support">
                            <div class="main-slider-seven__support-icon">
                                <i class="fas fa-headphones"></i>
                ...
                <div class="swiper-slide">
                    ...
                    <div class="main-slider-seven__img">
                        <img src="{{ asset('assets/images/update-17-06-2023/resources/main-slider-seven-img-3.jpg') }}"
                            alt="">
                        <div class="main-slider-seven__support">
                            <div class="main-slider-seven__support-icon">
                                <i class="fas fa-headphones"></i>
